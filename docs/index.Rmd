...
- Faremos aqui um guia “passo a passo” de como estruturar uma planilha para 
realizar a análise financeira no contexto desejado (a interpretação da análise 
também é ensinada). A ideia é que você crie **INDEPENDÊNCIA** para elaborar as 
suas análises de acordo com as especificidades do projeto. 


- **FIQUE ATENTO** quando o **TEXTO APARECER EM NEGRITO**, isto significa que o 
conceito apresentado é muito importante para a **AVALIAÇÃO ECONÔMICA**.
...
atendidos e 85,93% do total de potência nominal instalada:
  ...
  - Unidades Consumidoras: 1.828.433;

  - Potência Instalada: 14.923.378, 14 kWp.
